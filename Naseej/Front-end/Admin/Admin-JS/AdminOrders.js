...
async function getOrderHistory() {
    const url = `https://localhost:7158/api/CartAndOrder/getAllOrders`;
...
async function filterOrderStatus() {
    ...
    const url = `https://localhost:7158/api/CartAndOrder/getOrdersByStatus/${status}`;
    const response = await fetch(url);
